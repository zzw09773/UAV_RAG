...
### 之前的限制
```
User: "為 F-4 生成 for005.dat，S=530 ft², A=2.8, λ=0.3..."
...
#### 3. 完整檔案生成
```bash
./query.sh "為 F-4 Phantom II 生成完整的 DATCOM for005.dat，包含:
